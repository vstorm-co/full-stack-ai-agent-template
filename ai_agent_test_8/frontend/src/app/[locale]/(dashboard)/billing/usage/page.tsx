...
const DailyCreditsChart = dynamic(() => import("./usage-charts").then((m) => m.DailyCreditsChart), {
  ssr: false,
  loading: () => <div className="h-[240px]">{CHART_FALLBACK}</div>,
});
  ...
  return (
    <div className="space-y-6">
      ...
      {!isLoading && byModelChartData.length > 0 && (
        <ChartCard title="Usage by model" description="Tokens and credits, by model.">
