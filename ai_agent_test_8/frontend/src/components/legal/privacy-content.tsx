  ...
  return (
    <>
      ...
      <p>
        ...
        actions. See the <Link href={ROUTES.SECURITY}>Security page</Link> for details.
      </p>
  ...
  return (
    <>
      ...
      <p>
        ...
        administracyjnych. Szczegóły na <Link href={ROUTES.SECURITY}>stronie Bezpieczeństwo</Link>.
      </p>
