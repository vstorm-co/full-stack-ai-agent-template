...
class BillingService:
    ...
    async def create_checkout_session(
        ...
        *,
        ...
        try:
            ...
            raise BadRequestError(message="Invalid price_id format", details={"price_id": price_id})
    ...
    async def get_storage_usage(self, user_id: uuid.UUID, org_id: uuid.UUID) -> dict[str, Any]:
        ...
        return {
            "chat_files_bytes": chat_bytes,
            "rag_documents_bytes": rag_bytes,
            "total_bytes": chat_bytes + rag_bytes,
        }
